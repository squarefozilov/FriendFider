...
*Friend Finder* is deployed to Heroku. Please check it out [here](https://gentle-plateau-77072.herokuapp.com/).

## Installation

To install the application follow the instructions below:

	git clone git@github.com:squarefozilov/FriendFider.git
	cd friend-finder
	npm install
